...
(let ((colors (loop for h from 0 to 1 by (/ 1 32) collect (om-make-color-hsv h .8 .78))))
  ...
  (add-preference :midi :midi-ch10-color "10" :color (om-def-color :steelblue4))
  (add-preference :midi :midi-ch11-color "11" :color (om-def-color :yellow4))
  (add-preference :midi :midi-ch12-color "12" :color (om-def-color :burlywood4))
  (add-preference :midi :midi-ch13-color "13" :color (om-def-color :lightpink4))
  (add-preference :midi :midi-ch14-color "14" :color (om-def-color ::saddlebrown))
  (add-preference :midi :midi-ch15-color "15" :color (om-def-color :darkgreen))
  (add-preference :midi :midi-ch16-color "16" :color (om-def-color :darkslategrey))
  )
