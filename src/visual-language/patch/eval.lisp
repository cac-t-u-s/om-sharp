...
(add-preference :general :catch-errors "Handle Error Messages" :bool t "Catch Lisp errors and display a simple message window")
...
(defmethod eval-box ((self omboxeditcall))
  ...
  (let ((val (get-box-value self)))
    (when (and (and (boundp '*general-player*) *general-player*)
               (play-obj? val)
