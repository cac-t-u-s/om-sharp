...
(setf *om-strings* '((:a ("A" "La")) 
                     ...
                     (:file-not-saved-msg ("The file ~s could not be saved" "Le fichier ~s n'a pas pu être enregistré"))
                     (:file-not-exists ("The document could not be open. This file does not exist anymore: ~s" 
                      "Le fichier n'a pas pu être ouvert. Le chemin spécifié n'existe plus: ~s"))
                     ...
                     (:om-docversion-msg ("This document was saved in a higher version of OM" "Ce document a été créé ou enregistré dans une version plus récente de OM"))
                     (:upgrade-msg ("Please try to upgrade to this version or newer." "Veuillez mettre à jour le logiciel avant d'ouvrir ce document."))
