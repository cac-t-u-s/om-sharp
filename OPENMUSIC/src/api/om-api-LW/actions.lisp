...
(defclass om-interactive-object () ()
  (:default-initargs 
   :input-model '(
                  ...
                  ((:button-1 :nth-press :shift #+macosx :hyper #-macosx :control :meta) om-multiple-clic-callback (t t t))
                  ((:button-1 :nth-press :shift #+macosx :hyper #-macosx :control) om-multiple-clic-callback (t t nil))
                  ((:button-1 :nth-press :shift :meta) om-multiple-clic-callback (t nil t))
                  ((:button-1 :nth-press :meta #+macosx :hyper #-macosx :control) om-multiple-clic-callback (nil t t))
                  ((:button-1 :nth-press :shift ) om-multiple-clic-callback (t nil nil))
                  ((:button-1 :nth-press #+macosx :hyper #-macosx :control) om-multiple-clic-callback (nil t nil))
                  ((:button-1 :nth-press :meta) om-multiple-clic-callback (nil nil t))
                  ((:button-1 :nth-press) om-multiple-clic-callback (nil nil nil))
