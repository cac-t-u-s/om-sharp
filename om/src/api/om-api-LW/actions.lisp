...
(defclass om-interactive-object () ()
  (:default-initargs 
   :input-model '(
                  ...
                  #+windows((:button-1 :second-press :shift #+macosx :hyper #-macosx :control :meta) om-double-clic-callback (t t t))
                  #+windows((:button-1 :second-press :shift #+macosx :hyper #-macosx :control) om-double-clic-callback (t t nil))
                  #+windows((:button-1 :second-press :shift :meta) om-double-clic-callback (t nil t))
                  #+windows((:button-1 :second-press :meta #+macosx :hyper #-macosx :control) om-double-clic-callback (nil t t))
                  #+windows((:button-1 :second-press :shift ) om-double-clic-callback (t nil nil))
                  #+windows((:button-1 :second-press #+macosx :hyper #-macosx :control) om-double-clic-callback (nil t nil))
                  #+windows((:button-1 :second-press :meta) om-double-clic-callback (nil nil t))
                  #+windows((:button-1 :second-press) om-double-clic-callback (nil nil nil))
                  #-windows((:button-1 :nth-press :shift #+macosx :hyper #-macosx :control :meta) om-multiple-clic-callback (t t t))
                  #-windows((:button-1 :nth-press :shift #+macosx :hyper #-macosx :control) om-multiple-clic-callback (t t nil))
                  #-windows((:button-1 :nth-press :shift :meta) om-multiple-clic-callback (t nil t))
                  #-windows((:button-1 :nth-press :meta #+macosx :hyper #-macosx :control) om-multiple-clic-callback (nil t t))
                  #-windows((:button-1 :nth-press :shift ) om-multiple-clic-callback (t nil nil))
                  #-windows((:button-1 :nth-press #+macosx :hyper #-macosx :control) om-multiple-clic-callback (nil t nil))
                  #-windows((:button-1 :nth-press :meta) om-multiple-clic-callback (nil nil t))
                  #-windows((:button-1 :nth-press) om-multiple-clic-callback (nil nil nil))
